...
INSERT INTO USER (ID, USERNAME, PASSWORD, FIRSTNAME, LASTNAME, EMAIL, ENABLED, LASTPASSWORDRESETDATE) VALUES (4, 'pob', '$2a$10$wb1GESV/.89VM7vgP7qYH.gnjAqBklvGeHTiYucfjuse.jouPf3FS', 'user', 'user', 'disabled@user.com', 1, PARSEDATETIME('01-01-2016','dd-MM-yyyy'));
