...
.k-dropdowngrid-popup .k-header {
  background-image: linear-gradient(rgba(255,255,255,.45) 0%, rgba(255,255,255,0) 100%);
  border-color: #dedee0;
  color: #535b6a;
  background-color: #f3f3f4;
}
...
.k-dropdowngrid-popup .k-item.k-state-hover {
  background-image: linear-gradient(rgba(255,255,255,.3) 0%, rgba(255,255,255,0) 100%);
  border-color: #dedee0;
  color: #515967;
  background-color: #b6bdca;
}
.k-dropdowngrid-popup .k-item.k-state-selected {
  background-image: linear-gradient(rgba(255,255,255,0) 0%, rgba(255,255,255,.2) 100%);
  border-color: #dedee0;
  color: #fff;
  background-color: #1984c8;
}
