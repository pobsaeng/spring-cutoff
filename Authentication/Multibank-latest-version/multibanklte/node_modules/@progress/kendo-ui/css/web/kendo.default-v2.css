...
.k-action-buttons .k-primary:focus {
  box-shadow: inset 0 0 0 2px hsla(0, 0%, 93%, 0.3);
}
.k-action-buttons .k-primary.k-state-active,
.k-action-buttons .k-primary:active {
  border-color: inherit;
...
.k-gantt-columns .k-nonwork-hour {
  background-color: hsla(0, 0%, 40%, 0.025);
}
.k-line {
  color: #000;
}
...
.k-mediaplayer-titlebar {
  color: #fff;
  background-image: linear-gradient(hsla(0, 0%, 40%, 0.7), hsla(0, 0%, 40%, 0));
  text-shadow: 0 0 2px hsla(0, 0%, 40%, 0.5);
}
.k-mediaplayer-toolbar {
  color: #656565;
...
.k-chat .k-message-box.k-state-focused {
  box-shadow: 0 0 40px hsla(0, 0%, 40%, 0.1);
}
