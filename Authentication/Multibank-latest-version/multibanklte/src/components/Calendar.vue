      ...
      <div id="add-holiday-modal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="box-header with-bg-calendar">
...
export default {
  ...
  methods: {
    montaTodos(items) {
      return new Promise((resolve, reject) => {
        ...
        for(var key in items){
          holidays.push({
            id: items[key].holidayId,
            title: items[key].holidayName,
            start: moment(items[key].holidayDate)
          })
    ...
    createCalendar() {
      ...
      var args = {
        ...
        events(start, end, timezone, callback) {
          ...
          axios.get(url, 
          {
            ...
            headers: {
              ...
              // me.montaTodos(response.data).then((response) => {
              //   console.log("*********************");
        ...
        eventAfterAllRender: function (view) {
            ...
            $('.fc-toolbar.fc-header-toolbar').classList = "fc-header-calendar-toolbar";
    ...
    createButtonEL() {
      ...
      btnCreate.classList = "btn bg-orange margin";
      // btnCreate.classList = "btn bg-orange margin";
